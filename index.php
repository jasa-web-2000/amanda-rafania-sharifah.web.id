...
$title = "Travel Sanggata Terbaik dari " . $brand;
...
$rute = [
  "Travel Sangatta Bontang",
  "Travel Sangatta Samarinda",
  "Travel Sangatta Balikpapan",

  "Travel Sangatta Rantau Pulung",
  "Travel Sangatta Bengalon",
  "Travel Sangatta Sangkulirang",
  "Travel Sangatta Kaliorang",
  "Travel Sangatta Kaubun",
  "Travel Sangatta Wahau",
  ...
  "Travel Samarinda Sangatta",
  "Travel Balikpapan Sangatta",

  "Travel Rantau Sangatta Pulung",
  "Travel Bengalon Sangatta",
  "Travel Sangkulirang Sangatta",
  "Travel Kaliorang Sangatta",
  "Travel Kaubun Sangatta",
            ...
            <?php foreach ($rute as $item) : ?>
              <div class="">
                ...
                <div class="">
                  ...
                  <p class="text-sm opacity-80 my-2">Pesan <?= $item ?> untuk hari ini dan dapatkan promo spesial beserta bonus makan</p>
